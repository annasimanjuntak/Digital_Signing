!(function (t, e) {
        ...
        return (
          ...
          d <= 0 || d > e
            ? (r && (clearTimeout(r), (r = null)),
              ...
              (s = t.apply(o, n)),
              r || (o = n = null))
            : r || !1 === i.trailing || (r = setTimeout(a, d)),
          s
        );
      };
    }
    function o(t, e) {
      ...
      (this.velocityFilterWeight = s.velocityFilterWeight || 0.7),
        ...
        this.throttle
          ? (this._strokeMoveUpdate = i(o.prototype._strokeUpdate, this.throttle))
    ...
    return (
      ...
      (o.prototype._strokeUpdate = function (t) {
        ...
        if (!s || !r) {
          var h = this._addPoint(o),
            a = h.curve,
            c = h.widths;
          a && c && this._drawCurve(a, c.start, c.end),
      ...
      (o.prototype._strokeEnd = function (t) {
        ...
        if ((!e && i && this._drawDot(i), i)) {
          var o = this._data[this._data.length - 1],
            n = o[o.length - 1];
          i.equals(n) ||
            o.push({ x: i.x, y: i.y, time: i.time, color: this.penColor });
        }
      ...
      (o.prototype._addPoint = function (t) {
        ...
        if ((i.push(t), i.length > 2)) {
          3 === i.length && i.unshift(i[0]),
            (o = this._calculateCurveControlPoints(i[0], i[1], i[2]));
          var n = o.c2;
      ...
      (o.prototype._calculateCurveWidths = function (t) {
        var e = t.startPoint,
          ...
          n =
            this.velocityFilterWeight * i.velocityFrom(e) +
      ...
      (o.prototype._drawCurve = function (t, e, i) {
        ...
        for (var r = 0; r < s; r += 1) {
          var h = r / s,
            ...
            u = l * d,
            v = u * t.startPoint.x;
          (v += 3 * l * h * t.control1.x),
            (v += 3 * d * a * t.control2.x),
            (v += c * t.endPoint.x);
          var p = u * t.startPoint.y;
          (p += 3 * l * h * t.control1.y),
            (p += 3 * d * a * t.control2.y),
            (p += c * t.endPoint.y);
          var _ = e + c * n;
      ...
      (o.prototype._toSVG = function () {
        ...
        r.setAttributeNS(null, "width", i.width),
          r.setAttributeNS(null, "height", i.height),
          this._fromData(
            e,
            function (t, e, i) {
            ...
            function (e) {
              ...
              i.setAttribute("r", o),
                i.setAttribute("cx", e.x),
                i.setAttribute("cy", e.y),
                i.setAttribute("fill", e.color),
                r.appendChild(i);
            }
          );
        var h =
